...
-- CreateEnum
CREATE TYPE "MaintenanceStatus" AS ENUM ('PENDING_APPROVAL', 'APPROVED', 'REJECTED', 'IN_PROGRESS', 'COMPLETED');
...
-- CreateIndex
CREATE INDEX "Allocation_assigneeId_status_idx" ON "Allocation"("assigneeId", "status");

-- CreateIndex
CREATE INDEX "Booking_assetId_startDate_endDate_idx" ON "Booking"("assetId", "startDate", "endDate");

-- CreateIndex
CREATE INDEX "Booking_requesterId_startDate_endDate_idx" ON "Booking"("requesterId", "startDate", "endDate");
...
-- AddForeignKey
ALTER TABLE "Allocation" ADD CONSTRAINT "Allocation_assigneeId_fkey" FOREIGN KEY ("assigneeId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
